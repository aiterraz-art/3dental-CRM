                ...
                <div className="flex-1 premium-card overflow-hidden relative z-0 rounded-3xl">
                    ...
                    >
                        {userLocation && (
                            <>
                                <AdvancedMarker position={userLocation}>
                                    <Pin background={'#6366f1'} borderColor={'#4338ca'} glyphColor={'white'} scale={1.2} />
                                </AdvancedMarker>
                        ...
                        {filteredClients.map(client => (
                            <AdvancedMarker
                                key={client.id}
                                position={{ lat: client.lat as number, lng: client.lng as number }}
                                onClick={() => setSelectedClient(client)}
                            >
                                <Pin background={'#10b981'} borderColor={'#047857'} glyphColor={'white'} />
                            </AdvancedMarker>
                        ))}
                        ...
                        {leads.map(lead => (
                            lead.geometry?.location && (
                                ...
                                >
                                    <Pin background={'#9ca3af'} borderColor={'#4b5563'} glyphColor={'white'} scale={0.8} />
                                </AdvancedMarker>
                            )
                        ))}
