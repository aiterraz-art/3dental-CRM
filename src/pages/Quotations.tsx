            ...
            if (manualLocation) {
                ...
                const position = await new Promise<GeolocationPosition>((resolve, reject) => {
                    navigator.geolocation.getCurrentPosition(resolve, (err) => {
                        console.error("GPS attempt failed:", err);
                        reject(new Error("No se pudo obtener la ubicación. Por favor, asegúrate de tener el GPS encendido y permitir el acceso a la ubicación en tu navegador."));
                    }, {
                        timeout: 10000,
                ...
                selectedForTemplate && (
                    <QuotationTemplate
                        data={{
                            ...
                            clientAddress: selectedForTemplate.client?.address || 'Sin Dirección',
