                ...
                <div ref={contentRef} className="flex-1 p-12 bg-white text-gray-800 print:p-0 font-sans">
                    ...
                    <div className="flex justify-between items-start mb-10 border-b-2 border-slate-900 pb-8">
                        <div className="flex items-center gap-4">
                            <img src="/logo_3dental.png" alt="3dental" className="h-16 w-auto grayscale" />
                            <div>
                                <p className="font-black text-xl uppercase tracking-tighter">3Dental<span className="font-light">Digital</span></p>
