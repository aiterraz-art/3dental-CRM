...
import { LayoutDashboard, Map as MapIcon, Calendar, Users, Package, LogOut, Search, Bell, Settings, ShieldCheck, ShoppingBag, UserCircle, Truck, Menu, X } from 'lucide-react';
                ...
                <div className="p-8 flex-1 overflow-y-auto">
                    <div className="flex items-center justify-between mb-12">
                        <div className="flex items-center space-x-4">
                            ...
                            <h1 className="text-white text-xl font-black tracking-tight">3dental CRM</h1>
                        </div>
                ...
                <header className="lg:hidden h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 shrink-0 relative z-30">
                    <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-side-gradient rounded-xl flex items-center justify-center shadow-lg">
                            <img src="/logo_3dental.png" alt="3dental" className="w-6 h-6 object-contain brightness-0 invert" />
                        </div>
                        <h1 className="text-gray-900 text-lg font-black tracking-tighter">3dental CRM</h1>
                    </div>
                    <button
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12">
                    ...
                    <div className="mt-12 py-6 border-t border-gray-100/50 text-center">
                        <p className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">
                            © {new Date().getFullYear()} 3dental - Gestión Profesional
                        </p>
                    </div>
                </div>
            </main>
